...
final class Version20201210191000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tipo CHANGE eliminado_por eliminado_por INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tipo CHANGE eliminado_por eliminado_por INT DEFAULT NULL');
    }
}
